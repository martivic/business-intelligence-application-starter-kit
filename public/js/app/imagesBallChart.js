(function(app) {
  'use strict';
  app.ImagesBallChart = function(dom, args) {
  ...
  app.ImagesBallChart.prototype._setup = function() {
    var margin = {
        top: 10,
        right: 30,
        bottom: 10,
  ...
  app.ImagesBallChart.prototype.onClickHandle = function(/*data*/) {

  };


  app.ImagesBallChart.prototype._formatNumber = function(data) {
    var num = data.count,
  ...
  app.ImagesBallChart.prototype.remove = function() {
    this._svg.remove();
    this.domNode.remove();
  };
